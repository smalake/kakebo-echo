...
func (m *MockEventRepository) GetOne(arg0 int) (model.Event, error) {
	m.ctrl.T.Helper()
...
func (mr *MockEventRepositoryMockRecorder) GetOne(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOne", reflect.TypeOf((*MockEventRepository)(nil).GetOne), arg0)
}
